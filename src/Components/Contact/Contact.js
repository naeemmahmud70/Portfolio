                ...
                <form data-aos="fade-up" className="d-flex justify-content-center" onSubmit={sendEmail}>
                    <div className="col-md-6">
                        ...
                        <div className=" form-group pt-2 text-center">
                            <textarea className="form-control" name="message" id="" cols="24" rows="8" placeholder="Your message"></textarea><br />
                            <input id="send-btn" hidden="hidden" type="submit" value="Send Message" className="card-btn fw-bold mb-2" />
                            <label htmlFor="send-btn" className="card-btn fw-bold"> Send Message <FontAwesomeIcon className="font-awesome" icon={faPaperPlane} /> </label>
                        </div>
                    </div>
                </form>
            </div>
